"""
PATCH v2 — Remplace TransitionLLC et QcmMedas par ligne
"""
import sys
...
print(f"TransitionLLC: L{trans_start+1}")
print(f"QcmMedas: L{medas_start+1}")
print(f"QcmSante: L{sante_start+1}")
...
# Replace lines trans_start to medas_start with NEW_TRANSITION
# Replace lines medas_start to sante_start with NEW_MEDAS
new_lines = (
    lines[:trans_start] +
    [NEW_TRANSITION] +
    [NEW_MEDAS] +
...
print("✅ TransitionLLC + QcmMedas redesignés")
print(f"Fichier : {out}")
